    ...
    <nav class="flex">
        ...
        <div class="py-4">
            <a href="https://twitter.com/RobinMartijn/" target="_blank" aria-label="Twitter">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-8 ml-4 md:ml-8 fill-gray-300 hover:fill-white">
                    <path
        ...
        <div class="py-4">
            <a href="https://github.com/Bowero" target="_blank" aria-label="GitHub">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="h-8 ml-4 md:ml-8 fill-gray-300 hover:fill-white">
                    <path
